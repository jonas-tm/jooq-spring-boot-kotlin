...
* The original package name 'me.jonastm.jooq-sample' is invalid and this project uses 'me.jonastm.jooqsample' instead.
...
```
$ docker run --rm -p 8080:8080 jooq-sample:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/jooq-sample
```
